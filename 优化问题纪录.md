...
#SystemUI一直停止运行
最近在做下载模块的分析，发现在稍微低端的android手机上下载任务一多就容易产生systemui停止运行的问题，通过问题分析<br>
发现在通知栏一直在更新，现在功能有很容易下载20个左右的任务，然后在通知栏上对应有20个通知任务，然后在下载过程中实施更新通知栏<br>
导致在samsung note2， redmi 和lenoveo 4.0-4.4手机上导致卡死，systemui一直重启，现在的解决方案对下载任务做限制，只针对下载<br>
